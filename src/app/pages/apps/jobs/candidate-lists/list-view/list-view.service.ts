...
function sort(countries: ListViewModel[]): ListViewModel[] {
  // if (direction === '') {
  return countries;
  // } else {
...
function matches(country: ListViewModel, term: string, pipe: PipeTransform) {
...
export class ListViewService {
  ...
  private _countries$ = new BehaviorSubject<ListViewModel[]>([]);
